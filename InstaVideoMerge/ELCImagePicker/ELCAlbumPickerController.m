...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *refreshItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"menu"] style:UIBarButtonItemStylePlain target:self.parent action:@selector(showMenuOptions)];
